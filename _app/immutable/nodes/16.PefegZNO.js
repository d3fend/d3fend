import{s as ae,b as u,e as m,j as d,d as f,v as C,f as W,i as o,w as y,k as l,l as T,t as B,h as V,n as Q}from"../chunks/scheduler.rYb7pZZG.js";import{S as ie,i as se,c as N,b as P,m as F,t as I,a as S,d as R}from"../chunks/index.DuGWJhq4.js";import{T as oe}from"../chunks/TaxoMatrix.BIEi3Y7_.js";import{G as le}from"../chunks/_Graph.8vsriYIQ.js";import{G as re}from"../chunks/lib.FzuLk5Dt.js";import{A as ce}from"../chunks/Alert.4Peyoxud.js";import{T as me}from"../chunks/Title.-2iHfz2o.js";/* empty css                                                                 */import{S as fe}from"../chunks/ScrollFrame.g1dSKooO.js";async function pe({params:p,fetch:t}){return await(await t("/api/taxonomies/d3f:AnalyticTechnique.json")).json()}const Ee=Object.freeze(Object.defineProperty({__proto__:null,load:pe},Symbol.toStringTag,{value:"Module"}));function ue(p){let t,n,a="Characterizing D3FEND Techniques with Analytic Techniques ",c;return{c(){t=B(`flowchart TD
        ...
        It also can also ensure that a capabilty is a good match for the particular situation and intended problem set.</p> <p></p>`,L,M,z,b,H,h,te="Analytic Technique Taxonomy",j,O,U,x,g,G;return t=new me({props:{title:`D3FEND ${p[0].i(ne)["rdfs:label"]} Taxonomy`}}),v=new le({props:{$$slots:{default:[ue]},$$scope:{ctx:p}}}),b=new ce({props:{$$slots:{default:[de]},$$scope:{ctx:p}}}),g=new fe({props:{$$slots:{default:[he]},$$scope:{ctx:p}}}),{c(){N(t.$$.fragment),n=u(),a=m("div"),a.innerHTML=c,s=u(),r=m("div"),D=m("section"),D.innerHTML=Y,X=u(),k=m("div"),$=m("figure"),N(v.$$.fragment),J=u(),A=m("figcaption"),A.textContent=Z,K=u(),_=m("section"),_.innerHTML=ee,L=u(),M=m("br"),z=u(),N(b.$$.fragment),H=u(),h=m("h1"),h.textContent=te,j=u(),O=m("br"),U=u(),x=m("section"),N(g.$$.fragment),this.h()},l(e){P(t.$$.fragment,e),n=d(e),a=f(e,"DIV",{class:!0,"data-svelte-h":!0}),C(a)!=="svelte-a7ce36"&&(a.innerHTML=c),s=d(e),r=f(e,"DIV",{});var i=W(r);D=f(i,"SECTION",{class:!0,"data-svelte-h":!0}),C(D)!=="svelte-9vzt6g"&&(D.innerHTML=Y),X=d(i),k=f(i,"DIV",{class:!0});var q=W(k);$=f(q,"FIGURE",{});var w=W($);P(v.$$.fragment,w),J=d(w),A=f(w,"FIGCAPTION",{class:!0,"data-svelte-h":!0}),C(A)!=="svelte-1rk40wb"&&(A.textContent=Z),w.forEach(o),q.forEach(o),K=d(i),_=f(i,"SECTION",{class:!0,"data-svelte-h":!0}),C(_)!=="svelte-r752xk"&&(_.innerHTML=ee),i.forEach(o),L=d(e),M=f(e,"BR",{}),z=d(e),P(b.$$.fragment,e),H=d(e),h=f(e,"H1",{id:!0,class:!0,"data-svelte-h":!0}),C(h)!=="svelte-1h4jsdk"&&(h.textContent=te),j=d(e),O=f(e,"BR",{}),U=d(e),x=f(e,"SECTION",{class:!0});var E=W(x);P(g.$$.fragment,E),E.forEach(o),this.h()},h(){y(a,"class","logo text-center"),y(D,"class","content svelte-13ynke6"),y(A,"class","s-PalH6l0zoH1z"),y(k,"class","text-center center"),y(_,"class","content svelte-13ynke6"),y(h,"id","acf"),y(h,"class","text-center"),y(x,"class","svelte-13ynke6")},m(e,i){F(t,e,i),l(e,n,i),l(e,a,i),l(e,s,i),l(e,r,i),T(r,D),T(r,X),T(r,k),T(k,$),F(v,$,null),T($,J),T($,A),T(r,K),T(r,_),l(e,L,i),l(e,M,i),l(e,z,i),F(b,e,i),l(e,H,i),l(e,h,i),l(e,j,i),l(e,O,i),l(e,U,i),l(e,x,i),F(g,x,null),G=!0},p(e,[i]){const q={};i&4&&(q.$$scope={dirty:i,ctx:e}),v.$set(q);const w={};i&4&&(w.$$scope={dirty:i,ctx:e}),b.$set(w);const E={};i&4&&(E.$$scope={dirty:i,ctx:e}),g.$set(E)},i(e){G||(I(t.$$.fragment,e),I(v.$$.fragment,e),I(b.$$.fragment,e),I(g.$$.fragment,e),G=!0)},o(e){S(t.$$.fragment,e),S(v.$$.fragment,e),S(b.$$.fragment,e),S(g.$$.fragment,e),G=!1},d(e){e&&(o(n),o(a),o(s),o(r),o(L),o(M),o(z),o(H),o(h),o(j),o(O),o(U),o(x)),R(t,e),R(v),R(b,e),R(g)}}}let ve=9,be=1,ne="d3f:AnalyticTechnique",ge="/acf/technique";function Te(p,t,n){let{data:a}=t,c=new re(a,{index:!0});return p.$$set=s=>{"data"in s&&n(1,a=s.data)},[c,a]}class Ne extends ie{constructor(t){super(),se(this,t,Te,ye,ae,{data:1})}}export{Ne as component,Ee as universal};
