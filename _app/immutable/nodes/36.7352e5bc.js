import{s as h,a as y,f as m,c as d,g as p,F as u,j as f,i as n,y as b,d as c}from"../chunks/scheduler.50831561.js";import{S as v,i as w,b as g,d as P,m as T,a as I,t as E,e as M}from"../chunks/index.24431cc3.js";import{T as R}from"../chunks/Title.28d88b77.js";function _(l){let t,i,o,s=`<h1>Privacy Policy</h1> <p>Effective Date: June 22, 2022</p> <p>The MITRE Corporation (“MITRE”) respects the privacy of its website users.</p> <p>This Privacy Policy explains the types of information collected by MITRE
    ...
    Site, you understand and agree to terms outlined in this Privacy Policy.</p> <h4>Information Collected from Cookies on Web Traffic Reporting and Content
    Tools</h4> <p>“Cookies” are data that may be sent to your web browser and stored on your
    ...
    web browser. MITRE does not employ cookies for this Site.</p> <p>However, the MITRE D3FEND website is hosted on GitHub®. GitHub uses a free
    ...
    <a href="https://docs.github.com/en/github/site-policy">https://docs.github.com/en/github/site-policy</a>.</p> <h4>Information Collected from E-mail and Web Forms</h4> <p>Users may contact MITRE electronically, via <a href="mailto:d3fend@mitre.org">d3fend@mitre.org</a>. MITRE may share the information that you provide to us via e-mail within
    ...
    commercial purpose.</p> <h4>Information Collected from Third Party Software and Media Sites</h4> <p>When Users visit the Site, Users may link to third party software and/or
    ...
    please see their respective website.</p> <h4>Changes to Our Privacy Policy</h4> <p>The Site may change from time to time. As a result, at times it may be
    ...
    Policy.</p>`,a;return t=new R({props:{title:"Privacy Policy"}}),{c(){g(t.$$.fragment),i=y(),o=m("section"),o.innerHTML=s,this.h()},l(e){P(t.$$.fragment,e),i=d(e),o=p(e,"SECTION",{class:!0,"data-svelte-h":!0}),u(o)!=="svelte-1mmohuq"&&(o.innerHTML=s),this.h()},h(){f(o,"class","content")},m(e,r){T(t,e,r),n(e,i,r),n(e,o,r),a=!0},p:b,i(e){a||(I(t.$$.fragment,e),a=!0)},o(e){E(t.$$.fragment,e),a=!1},d(e){e&&(c(i),c(o)),M(t,e)}}}class H extends v{constructor(t){super(),w(this,t,null,_,h,{})}}export{H as component};
