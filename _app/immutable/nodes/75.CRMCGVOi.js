import{s as D,n as p,d as u,i as A,v as T,c as y,w as k,h as f,b as d,e as x,g as v,M as F,j as w,N as j}from"../chunks/cxan7wOg.js";import{S as C,i as N,d as q,t as S,a as z,m as I,c as _,b as L}from"../chunks/CkylGIUQ.js";import{m as R}from"../chunks/CesSW9Du.js";/* empty css                */import{b as a}from"../chunks/Bj-k5Abv.js";function O(c){let e,t='<div style="display: flex; just-content: space-between; align-items: center;"><div style="text-align: center; flex-grow: 1;"><h1 class="fancy-font">D3FEND <span class="snakes">☤</span> <span class="CAD"><span style="color:#e62929;">C</span><span class="A" style="color:white;text-border:1px;">A</span><span style="color:blue;">D</span></span></h1> <div style="text-align: center; padding: 0 px"><i>Cyber Attack-Defense Utility for Capturing Engagements and Understandable Scenarios</i></div> <br/></div></div>';return{c(){e=f("div"),e.innerHTML=t,this.h()},l(s){e=y(s,"DIV",{class:!0,"data-svelte-h":!0}),k(e)!=="svelte-60rjil"&&(e.innerHTML=t),this.h()},h(){T(e,"class","title-egg")},m(s,o){A(s,e,o)},p,i:p,o:p,d(s){s&&u(e)}}}class P extends C{constructor(e){super(),N(this,e,null,O,D,{})}}function U(c){let e,t,s,o,l,E=R(c[0])+"",m,r,g=`.content {
      min-width: 800px;
      max-width: 100%;
      overflow-x: auto;
      overflow: visible;
  ...
  }`,h;return t=new P({}),{c(){e=f("div"),L(t.$$.fragment),s=w(),o=f("section"),l=new j(!1),m=w(),r=f("style"),r.textContent=g,this.h()},l(n){e=y(n,"DIV",{});var i=x(e);_(t.$$.fragment,i),s=v(i),o=y(i,"SECTION",{class:!0});var b=x(o);l=F(b,!1),b.forEach(u),m=v(i),r=y(i,"STYLE",{"data-svelte-h":!0}),k(r)!=="svelte-1u50i2u"&&(r.textContent=g),i.forEach(u),this.h()},h(){l.a=null,T(o,"class","content")},m(n,i){A(n,e,i),I(t,e,null),d(e,s),d(e,o),l.m(E,o),d(e,m),d(e,r),h=!0},p,i(n){h||(z(t.$$.fragment,n),h=!0)},o(n){S(t.$$.fragment,n),h=!1},d(n){n&&u(e),q(t)}}}function M(c){return[`
...
## 2. CAD UI Elements
<div class="zoom"><p align="left"><img src="${a}/img/ui_overview.jpg" style="border: 3px solid #555" alt="CAD UI Overview"></p></div>
...
<div class="zoom"><p align="left"><img src="${a}/img/canvas_overview.jpg" style="border: 3px solid #555" alt="CAD Canvas Overview"></p></div>
...
<p align="left"><img src="${a}/img/node_anatomy.jpg" style="border: 3px solid #555" alt="CAD Node Overview"></p>
...
<p align="left"><img src="${a}/img/class_picker_example.jpg" style="border: 3px solid #555" alt="Class Picker Example"></p>
...
<p align="left"><img src="${a}/img/node_details_example.jpg" style="border: 3px solid #555" alt="Node Details Example"></p>
...
<p align="left"><img src="${a}/img/node_context_menu.jpg" style="border: 3px solid #555" alt="Node Context Menu Example"></p>
...
<p align="left"><img src="${a}/img/relationships_overview.jpg" style="border: 3px solid #555" alt="Relationships Overview"></p>
...
<div class="zoom"><p align="left"><img src="${a}/img/inference_example.jpg" style="border: 3px solid #555" alt="Inference Example"></p></div>
...
<p align="left"><img src="${a}/img/custom_values_example.jpg" style="border: 3px solid #555" alt="Custom Values Example"></p>
...
<p align="left"><img src="${a}/img/using_object_properties.jpg" style="border: 3px solid #555" alt="Using Node Instance Properties Correctly"></p>
...
`]}class B extends C{constructor(e){super(),N(this,e,M,U,D,{})}}export{B as component};
