import"../chunks/Bzak7iHL.js";import{o as ne}from"../chunks/o0JyXpVK.js";import{a as x,d as w,p as K,aM as J,a1 as Q,f as ie,s as j,A as i,b as Z,b1 as F,c as f,r as l,t as Y,z as W,b0 as se}from"../chunks/C5fqCc9O.js";import{e as ee,i as te}from"../chunks/DzcpJ-1p.js";import{h as re}from"../chunks/BhUBJ9bE.js";import{m as B}from"../chunks/CesSW9Du.js";import"../chunks/z-zb-vOA.js";import{s as ce}from"../chunks/B0SftDD_.js";import{i as H}from"../chunks/B7bOfw0f.js";import{a as de,b as le,s as V,c as $}from"../chunks/BYdHoday.js";import{p as he}from"../chunks/BAIJt-Fa.js";import{I as ae}from"../chunks/DXLVUi61.js";import{r as d}from"../chunks/DDYLM6Yj.js";import{g as pe}from"../chunks/CS5eGvzq.js";import{B as X,f as ue}from"../chunks/CxYgBcg5.js";import{s as L,q as me,l as fe}from"../chunks/DcLkHCEf.js";import{g as ye}from"../chunks/D24HvJwK.js";var ge=w('<div class="title-egg"><div style="display: flex; justify-content: space-between; align-items: center;"><div style="text-align: center; flex-grow: 1;"><h1 class="fancy-font">D3FEND <span class="snakes">☤</span> <span class="CAD"><span style="color:var(--d3fend-brand-cad-c);">C</span><span class="A" style="color: var(--d3fend-color-white);">A</span><span style="color:blue;">D</span></span></h1> <div style="text-align: center; padding: 0;"><i>Cyber Attack-Defense Utility for Capturing Engagements and Understandable Scenarios</i></div> <br/></div></div></div>');function be(D){var s=ge();x(D,s)}var ve=w('<div class="nav-section"><span aria-hidden="true"><!></span> <a> </a></div>'),xe=w('<div class="nav-item"><!></div>'),we=w("<div></div>"),De=w("<!> <!>",1);function oe(D,s){var v;K(s,!0);let y=he(s,"level",3,0);const A=F(()=>{var r,o;return!!((o=(r=s.node)==null?void 0:r.children)!=null&&o.length)}),S=F(()=>y()===0?"section-link":"child-link"),R=F(()=>y()===0?"nav-children":"nav-grandchildren");let T=J(Q(((v=s.node)==null?void 0:v.open)??!1));const k=F(()=>i(T)||s.node.open||!1);function M(){W(T,!i(T))}var P=De(),_=ie(P);{var C=r=>{var o=ve(),h=f(o);let g;var m=f(h);ae(m,{size:32,iconName:"arrowDown",description:"Toggle section",title:"Toggle section",iconClick:M}),l(h);var p=j(h,2),N=f(p,!0);l(p),l(o),Y(()=>{g=de(h,"",g,{visibility:i(A)?"visible":"hidden",rotate:i(k)?"0deg":"-90deg"}),le(p,"href",`#${s.node.id}`),V(p,1,$(i(S)),"svelte-9o5bc"),ce(N,s.node.title??s.node.label)}),x(r,o)};H(_,r=>{y()>=0&&r(C)})}var q=j(_,2);{var I=r=>{var o=we();ee(o,21,()=>s.node.children,te,(h,g)=>{var m=xe(),p=f(m);{let N=F(()=>y()+1);oe(p,{get node(){return i(g)},get level(){return i(N)}})}l(m),x(h,m)}),l(o),Y(()=>V(o,1,$(i(R)),"svelte-9o5bc")),x(r,o)};H(q,r=>{i(A)&&i(k)&&r(I)})}x(D,P),Z()}var Ae=w(`<div><div class="layout"><aside class="sidebar"><!> <h2>CAD Docs Navigation</h2> <nav class="sidebar-nav"></nav></aside> <section class="content"><!> <!></section></div> <style>.layout {
      display: flex;
      min-height: 100vh;
    ...
    .sidebar {
      ...
      flex: 0 0 300px;
      height: 100vh;
      background: var(--d3fend-surface-quiet);
      border-right: 2px solid var(--d3fend-border-strong);
      padding: 1rem;
    ...
    .content th {
      background-color: var(--d3fend-neutral-150); /* Using neutral color */
    ...
    .content tr:hover {
      background-color: var(--d3fend-neutral-625);
    }
  ...
  .zoom:hover {
    transform: scale(1.5); 
  }</style></div>`);function Ue(D,s){K(s,!0);let y=[],A=[],S=[];function R(e,n,t){let a=e.map(c=>({id:L(c),title:c,open:!1,children:[]}));const b=new Map;a.forEach(c=>{const u=c.title.split(".")[0].trim();b.set(u,c)});const G=new Map;return n.forEach(c=>{const u=c.match(/^(\d+)\.(\d+)/);if(!u)return;const z=u[1],U=u[2],O=b.get(z);if(!O)return;const E={id:L(c),label:c,children:[]};O.children.push(E),G.set(`${z}.${U}`,E)}),t.forEach(c=>{const u=c.match(/^(\d+)\.(\d+)\.(\d+)/);if(!u)return;const z=u[1],U=u[2],O=`${z}.${U}`,E=G.get(O);E&&E.children.push({id:L(c),label:c})}),a}function T(e){const t=e.split(`
`).filter(a=>a.trim().startsWith("#"));for(let a=0;a<t.length;a++)t[a].startsWith("#### ")?S.push(t[a].replace(/^#+\s*/,"")):t[a].startsWith("### ")?A.push(t[a].replace(/^#+\s*/,"")):t[a].startsWith("## ")&&y.push(t[a].replace(/^#+\s*/,""));return R(y,A,S)}const k=new B.Renderer;k.heading=(e,n,t,a)=>{const b=L(t||e);return`<h${n} id="${b}">${e}</h${n}>`},B.use({renderer:k,mangle:!1,headerIds:!0});function M(e){if(!e.length)return"";const n=["","## 10 CAD App Documentation",""];return e.forEach((t,a)=>{var b;n.push(`### ${me(a,t.title)}`,""),(b=t.description)!=null&&b.trim()&&n.push(t.description.trim(),""),n.push(t.markdown.trim(),"")}),n.join(`
`)}const _=`
...
## 2. CAD UI Elements
<div class="zoom"><p align="left"><img src=${d("/img/ui_overview.jpg")} style="border: 3px solid var(--d3fend-text-muted)" alt="CAD UI Overview"></p></div>
...
- <button>Import</button>
  ...
  - <button>JSON-LD</button>: this imports a JSON-LD semantic graph file and attempts to render it in CAD.
  - <button>Turtle</button>: this imports a TTL semantic graph file and attempts to render it in CAD.
  - <button>Caldera Operation Report</button>: this imports a Caldera operation report JSON file and attempts to render it in CAD.
...
- <button>Save to Library</button>: this saves the current graph back into the selected graph in the library.
...
- <button>Merge</button>: this merges another CAD JSON graph into the current graph.
...
- <button>Undo</button> / <button>Redo</button>: these undo and redo changes made to the graph.
- <button>Auto Layout</button>: this applies an automatic layout to the current graph (useful for large or imported graphs).
...
- <button>Render Metadata</button>: this toggles rendering graph metadata directly on the canvas.
- <button>CAD Views</button>: this opens the CAD Views modal, including built-in graph projections and any views contributed by enabled CAD apps.
...
#### 2.1.4 Analyze Menu
The <button>Analyze</button> menu includes the following options:

- <button>Risk Matrix</button>: this opens the Risk Matrix viewer, which places nodes into a matrix based on their \`d3f:risk-impact\` and \`d3f:risk-likelihood\` properties.
- <button>Verify Edges</button>: this runs ontology-based edge analysis for D3FEND-mapped relationships and color-codes them (green = implied by the ontology; red = not implied).
...
<div class="zoom"><p align="left"><img src=${d("/img/canvas_overview.jpg")} style="border: 3px solid var(--d3fend-text-muted)" alt="CAD Canvas Overview"></p></div>
...
|----|-----------|-------|
|Event|This node captures instances of events and is therefore mapped to the \`d3f:Event\` ontology class.|Remote Command|
...
|Node|Description|Example|
|----|-----------|-------|
|Artifact|This node captures instances of physical, information, and information bearing artifacts associated with a digital computer system and is therefore mapped to the \`d3f:Artifact\` ontology class.|Network Packet|
|Agent|This node captures instances of a person or non-person entity, including threat actors.|APT39|
...
#### 2.3.5 Node Images
All node types can include an optional image. Use the image button on a node to add or replace an image.

After an image is attached, hover over it to show image controls. The controls allow replacing or removing the image, dragging the crop position, changing image scale, resetting the crop to a centered fit view, resizing the image area in caption mode, and toggling between caption mode and full-node image mode.

Caption mode keeps the node label and image visible when the graph is zoomed out while hiding node details. Full-node image mode expands the image to fill the node.
...
<p align="left"><img src=${d("/img/class_picker_example.jpg")} style="border: 3px solid var(--d3fend-text-muted)" alt="Class Picker Example"></p>
...
<p align="left"><img src=${d("/img/node_details_example.jpg")} style="border: 3px solid var(--d3fend-text-muted)" alt="Node Details Example"></p>
...
Multiple node instances can be selected and moved together while preserving their relative layout:

- To add or remove individual nodes from the current selection, hold <kbd>Command</kbd> on macOS or <kbd>Ctrl</kbd> on Windows/Linux and left-click each node instance.
- To select nodes by area, hold <kbd>Shift</kbd>, then left-click and drag across the canvas to draw a selection box around the node instances.
- To select every node and relationship in the graph, press <kbd>Command</kbd>+<kbd>A</kbd> on macOS or <kbd>Ctrl</kbd>+<kbd>A</kbd> on Windows/Linux.
- Once multiple nodes are selected, left-click and drag any selected node instance to move the selected group. Relationships connected to those nodes will redraw as the nodes move.
- To clear the selection, left-click an empty area of the canvas.

#### 3.1.3 Context Menus and Deleting and Duplicating Node Instances
<p align="left"><img src=${d("/img/node_context_menu.jpg")} style="border: 3px solid var(--d3fend-text-muted)" alt="Node Context Menu Example"></p>

All CAD node instances in a graph include a context menu, which is available by right-clicking on the node. By default, all node instances include the options of \`Spotlight\`, \`duplicate\`, and \`delete\`. Spotlight focuses the native CAD canvas on the node and its directly connected neighbors while keeping the visible graph fully editable. Increase the hop count to reveal more of the graph, or enable Pivot and select a visible node as the new spotlight target. Close Spotlight to restore the previous canvas viewport and view filters. Duplicate creates a copy of the node, while delete removes it from the CAD graph. Certain types of nodes also include other options in this menu that make use of inferences in the D3FEND ontology; for more information on these options, refer to section 3.3 below.

### 3.2 Adding and Editing Relationships
<p align="left"><img src=${d("/img/relationships_overview.jpg")} style="border: 3px solid var(--d3fend-text-muted)" alt="Relationships Overview"></p>
...
#### 3.2.2 Valid Paths Preview (Edge Context Menu)
Sometimes it's not obvious which D3FEND relationship (or sequence of relationships) can validly connect two node classes. CAD can search the D3FEND ontology for valid property paths between the source and target node classes.

- Right-click on a relationship edge and select \`Show valid paths\`.
- Browse candidate paths with the <button>&lt;</button> / <button>&gt;</button> buttons.
- Click <button>Insert</button> to replace the selected edge with the chosen path (intermediate nodes and relationships are inserted into your graph).
- Use <button>Dive deeper</button> to search longer paths if needed.

#### 3.2.3 Deleting Relationships
...
- **artifacts**: the artifacts associated with an Attack or Countermeasure.
...
- **add sensors**: the sensors that can be used to monitor or detect on a particular Artifact.
- **add weakness**: the software weaknesses (i.e., CWEs) that can be present in a function or code modeled as a Digital Artifact.
- **explode**
   - **explode all**: the full set of class inferences for an Artifact.
   - **explode parts**: the part inferences (i.e., child components) for an Artifact.
   - **explode control**: the neighbor inferences for an Artifact.
- **events**: the events that are associated with (e.g., can provide information on) an Artifact.
...
|Artifact|offensive techniques, defensive techniques, weaknesses, sensors, explode, events|
|Event|N/A|
|Note|N/A|
|Thing|N/A|
|Vulnerability|N/A|
...
<div class="zoom"><p align="left"><img src=${d("/img/inference_example.jpg")} style="border: 3px solid var(--d3fend-text-muted)" alt="Inference Example"></p></div>
...
<p align="left"><img src=${d("/img/custom_values_example.jpg")} style="border: 3px solid var(--d3fend-text-muted)" alt="Custom Values Example"></p>
...
### 4.3 Importing JSON-LD
CAD supports importing semantic graphs serialized as JSON-LD. To import a JSON-LD file, click <button>File</button> → <button>Import...</button> → <button>JSON-LD</button>.
### 4.4 Importing Turtle (TTL)
CAD supports importing semantic graphs serialized as TTL. To import a TTL file, click <button>File</button> → <button>Import...</button> → <button>Turtle</button>.
### 4.5 Importing Caldera Operation Reports
CAD supports importing Caldera operation report JSON files. To import a report, click <button>File</button> → <button>Import...</button> → <button>Caldera Operation Report</button>.
...
<p align="left"><img src=${d("/img/using_object_properties.jpg")} style="border: 3px solid var(--d3fend-text-muted)" alt="Using Node Instance Properties Correctly"></p>
...
`;let C=J(""),q=J(Q([]));function I(e){const n=M(ye(e));W(C,`${_}${n}`),W(q,T(i(C)),!0)}I(X),ne(async()=>{try{const e=await fe();I(ue(X,void 0,e))}catch(e){console.error("Failed to load CAD app documentation site config:",e)}});var v=Ae(),r=f(v),o=f(r),h=f(o);ae(h,{class:"sidebar-home-link",size:32,iconName:"arrowLeft",description:"Nav Back To CAD",title:"Nav Back To CAD",iconClick:()=>pe(d("/cad"))});var g=j(h,4);ee(g,21,()=>i(q),te,(e,n)=>{oe(e,{get node(){return i(n)},level:0})}),l(g),l(o);var m=j(o,2),p=f(m);be(p);var N=j(p,2);re(N,()=>B(i(C))),l(m),l(r),se(2),l(v),x(D,v),Z()}export{Ue as component};
