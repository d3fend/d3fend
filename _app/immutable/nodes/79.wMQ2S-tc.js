import"../chunks/Bzak7iHL.js";import"../chunks/C9XObT-s.js";import{a as f,c as g,p as W,aP as Q,a1 as V,f as X,s as N,A as c,b as B,b7 as C,d as u,r as l,t as P,z as K,g as $}from"../chunks/M0Oc_jcV.js";import{e as G,i as Y}from"../chunks/CpoRs9rA.js";import{h as Z}from"../chunks/MaqDuRK8.js";import{i as ee}from"../chunks/B_M0p879.js";import{m as R}from"../chunks/CesSW9Du.js";/* empty css                */import{s as te}from"../chunks/BudljjWB.js";import{i as M}from"../chunks/CF3N4BZN.js";import{a as ae,b as oe,s as U,c as J}from"../chunks/3N4rtv_S.js";import{p as ne}from"../chunks/DUgBX6tD.js";import{I as se}from"../chunks/B329tkAe.js";import{r as d}from"../chunks/DLFHhg9C.js";var ie=g('<div class="title-egg"><div style="display: flex; just-content: space-between; align-items: center;"><div style="text-align: center; flex-grow: 1;"><h1 class="fancy-font">D3FEND <span class="snakes">☤</span> <span class="CAD"><span style="color:#e62929;">C</span><span class="A" style="color:white;text-border:1px;">A</span><span style="color:blue;">D</span></span></h1> <div style="text-align: center; padding: 0 px"><i>Cyber Attack-Defense Utility for Capturing Engagements and Understandable Scenarios</i></div> <br/></div></div></div>');function re(b){var n=ie();f(b,n)}var ce=g('<div class="nav-section"><span aria-hidden="true"><!></span> <a> </a></div>'),de=g('<div class="nav-item"><!></div>'),le=g("<div></div>"),he=g("<!> <!>",1);function H(b,n){var T;W(n,!0);let y=ne(n,"level",3,0);const x=C(()=>{var s,o;return!!((o=(s=n.node)==null?void 0:s.children)!=null&&o.length)}),E=C(()=>y()===0?"section-link":"child-link"),m=C(()=>y()===0?"nav-children":"nav-grandchildren");let v=Q(V(((T=n.node)==null?void 0:T.open)??!1));const F=C(()=>c(v)||n.node.open||!1);function S(){K(v,!c(v))}var w=he(),j=X(w);{var D=s=>{var o=ce(),p=u(o);let a;var i=u(p);se(i,{size:32,iconName:"arrowDown",description:"Toggle section",title:"Toggle section",iconClick:S}),l(p);var e=N(p,2),t=u(e,!0);l(e),l(o),P(()=>{a=ae(p,"",a,{visibility:c(x)?"visible":"hidden",rotate:c(F)?"0deg":"-90deg"}),oe(e,"href",`#${n.node.id}`),U(e,1,J(c(E)),"svelte-9o5bc"),te(t,n.node.title??n.node.label)}),f(s,o)};M(j,s=>{y()>=0&&s(D)})}var q=N(j,2);{var A=s=>{var o=le();G(o,21,()=>n.node.children,Y,(p,a)=>{var i=de(),e=u(i);{let t=C(()=>y()+1);H(e,{get node(){return c(a)},get level(){return c(t)}})}l(i),f(p,i)}),l(o),P(()=>U(o,1,J(c(m)),"svelte-9o5bc")),f(s,o)};M(q,s=>{c(x)&&c(F)&&s(A)})}f(b,w),B()}var pe=g(`<div><div class="layout"><aside class="sidebar"><h2>CAD Docs Navigation</h2> <nav class="sidebar-nav"></nav></aside> <section class="content"><!> <!></section></div> <style>.layout {
      display: flex;
      min-height: 100vh;
  ...
  .zoom:hover {
    transform: scale(1.5); 
  }</style></div>`);function Ne(b,n){W(n,!1);let y=[],x=[],E=[];function m(a){return a.toLowerCase().trim().replace(/[^a-z0-9]+/g," ").trim().replace(/\s+/g,"-")}function v(a,i,e){let t=a.map(r=>({id:m(r),title:r,open:!1,children:[]}));const I=new Map;t.forEach(r=>{const h=r.title.split(".")[0].trim();I.set(h,r)});const _=new Map;return i.forEach(r=>{const h=r.match(/^(\d+)\.(\d+)/);if(!h)return;const L=h[1],O=h[2],z=I.get(L);if(!z)return;const k={id:m(r),label:r,children:[]};z.children.push(k),_.set(`${L}.${O}`,k)}),e.forEach(r=>{const h=r.match(/^(\d+)\.(\d+)\.(\d+)/);if(!h)return;const L=h[1],O=h[2],z=`${L}.${O}`,k=_.get(z);k&&k.children.push({id:m(r),label:r})}),t}function F(a){const e=a.split(`
`).filter(t=>t.trim().startsWith("#"));for(let t=0;t<e.length;t++)e[t].startsWith("#### ")?E.push(e[t].replace(/^#+\s*/,"")):e[t].startsWith("### ")?x.push(e[t].replace(/^#+\s*/,"")):e[t].startsWith("## ")&&y.push(e[t].replace(/^#+\s*/,""));return v(y,x,E)}const S=new R.Renderer;S.heading=(a,i,e,t)=>{const I=m(e||a);return`<h${i} id="${I}">${a}</h${i}>`},R.use({renderer:S,mangle:!1,headerIds:!0});const w=`
...
## 2. CAD UI Elements
<div class="zoom"><p align="left"><img src=${d("/img/ui_overview.jpg")} style="border: 3px solid #555" alt="CAD UI Overview"></p></div>
...
<div class="zoom"><p align="left"><img src=${d("/img/canvas_overview.jpg")} style="border: 3px solid #555" alt="CAD Canvas Overview"></p></div>
...
<p align="left"><img src=${d("/img/node_anatomy.jpg")} style="border: 3px solid #555" alt="CAD Node Overview"></p>
...
<p align="left"><img src=${d("/img/class_picker_example.jpg")} style="border: 3px solid #555" alt="Class Picker Example"></p>
...
<p align="left"><img src=${d("/img/node_details_example.jpg")} style="border: 3px solid #555" alt="Node Details Example"></p>
...
<p align="left"><img src=${d("/img/node_context_menu.jpg")} style="border: 3px solid #555" alt="Node Context Menu Example"></p>
...
<p align="left"><img src=${d("/img/relationships_overview.jpg")} style="border: 3px solid #555" alt="Relationships Overview"></p>
...
<div class="zoom"><p align="left"><img src=${d("/img/inference_example.jpg")} style="border: 3px solid #555" alt="Inference Example"></p></div>
...
<p align="left"><img src=${d("/img/custom_values_example.jpg")} style="border: 3px solid #555" alt="Custom Values Example"></p>


### 3.5 Querying CAD Graphs
Use the SPARQL Tab to query CAD graphs.

- Open a tab: click the down-arrow tab menu and select <button>SPARQL Query (alpha)</button>.
- Select a Target Dataset: Use the "TARGET" dropdown to choose between the default D3FEND ontology or a loaded CAD file as your SPARQL query target.
- Write or Load a Query: Enter your SPARQL query in the editor, or pick a sample from the "Example Queries" dropdown to auto-fill the editor.
- Run the Query: Click the green play button or press <kbd>Ctrl</kbd>+<kbd>Enter</kbd> (or <kbd>Cmd</kbd>+<kbd>Enter</kbd> on Mac) to execute your query.
- View and Explore Results: Query results will appear in a table on the right. Click on any <code>cad:</code> node link to zoom to that node in the graph (if available).
- Export or Clear Results: Use the buttons above the results table to clear output, or to save results as CSV or JSON-LD for further analysis.

### 3.6 CAD IDE (alpha)
The CAD IDE tab is an in-browser JavaScript scratchpad for inspecting and generating CAD JSON graphs.

- Open a tab: click the down-arrow tab menu and select <button>CAD IDE (alpha)</button>.
- Load an existing graph: use the \`LOAD\` dropdown to load an open CAD tab into the IDE canvas.
- Start from examples: use the \`Example Code\` dropdown to load example scripts.
- Modify the graph with code: scripts can read and modify \`temp_nodes\` and \`temp_edges\` (the current IDE canvas).
- Query the ontology: use \`sparql(query)\` to run SPARQL against the in-memory D3FEND dataset.
- Run and export: click the green play button (or <kbd>Ctrl</kbd>+<kbd>Enter</kbd>/<kbd>Cmd</kbd>+<kbd>Enter</kbd>) and use <button>Open in New Tab</button> to move the result into a normal CAD tab.
...
<p align="left"><img src=${d("/img/using_object_properties.jpg")} style="border: 3px solid #555" alt="Using Node Instance Properties Correctly"></p>
...
`;let j=F(w);ee();var D=pe(),q=u(D),A=u(q),T=N(u(A),2);G(T,5,()=>j,Y,(a,i)=>{H(a,{get node(){return c(i)},level:0})}),l(T),l(A);var s=N(A,2),o=u(s);re(o);var p=N(o,2);Z(p,()=>R(w)),l(s),l(q),$(2),l(D),f(b,D),B()}export{Ne as component};
