...
<script>
  ...
  `,At=({size:a,domain:e},t="<embed-data>",{metadataComp:l,metadata:n})=>`
<!DOCTYPE html>
<html lang="en">
  <head>
    <meta charset="UTF-8" />
...
`;function It(a){return{c:X,l:X,m:X,p:X,d:X}}function Tt(a){let e,t=a[25]+"",l;return{c(){e=p("pre"),l=z(t),this.h()},l(n){e=v(n,"PRE",{class:!0});var s=y(e);l=O(s,t),s.forEach(h),this.h()},h(){_(e,"class","svelte-tky2v8")},m(n,s){F(n,e,s),f(e,l)},p(n,s){s&16&&t!==(t=n[25]+"")&&Y(l,t)},d(n){n&&h(e)}}}function Nt(a){let e;return{c(){e=z("...loading")},l(t){e=O(t,"...loading")},m(t,l){F(t,e,l)},p:X,d(t){t&&h(e)}}}function Pt(a){let e,t,l,n,s='<h1 class="svelte-tky2v8"><span class="fancy-font">D3FEND</span> Embeddable CAD</h1> <h6 class="svelte-tky2v8">Use the D3FEND Embeddable CAD to embed an interactive D3FEND CAD in another webpage.</h6>',d,r,o,c,i,u,m,E,b,w,k,g,C,R,H,U,Z=a[3].text+"",Q,G,L,j,x,D,V,W,K,se,B,N,I,T,P,J,te,ee;e=new ut({props:{title:"Embedded D3FEND CAD",og_title:"MITRE Embedded D3FEND CAD",og_type:"website",og_url:"https://d3fend.mitre.org/",og_image:"https://d3fend.mitre.org/img/d3fend-og.png",og_description:"D3FEND CAD Analysis."}}),o=new Dt({props:{containerSize:a[5],metaData:a[6]}});function ue($){a[18]($)}let ae={inputClassName:"autocomplete-cursor-select",items:Object.values(a[7]),labelFieldName:"name",readonly:!0,onChange:a[17]};a[3]!==void 0&&(ae.selectedItem=a[3]),b=new ht({props:ae}),be.push(()=>dt(b,"selectedItem",ue));let q={ctx:a,current:null,token:null,hasCatch:!1,pending:Nt,then:Tt,catch:It,value:25};return Oe(C=a[4],q),N=new Ct({props:{metaData:a[6]}}),{c(){ge(e.$$.fragment),t=A(),l=p("main"),n=p("section"),n.innerHTML=s,d=A(),r=p("code"),ge(o.$$.fragment),c=A(),i=p("code"),u=p("h3"),m=z(`Embed Code
